                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" class="user" action="config/auth.php">
...
<?php
    ...
    if(isset($_GET['error'])){
        ...
        if($invalid == 2){
            echo "<script> swal('Login Gagal', 'Password Salah', 'error');</script>";   
        }else if($invalid == 3){
            echo "<script> swal('Login Gagal', 'User tidak ada', 'warning');</script>";   
        }else{
            echo "";
        }
    }
