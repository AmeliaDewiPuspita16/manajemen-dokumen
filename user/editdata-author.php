            ...
            <div class="card-body">
                <form method="POST" action="proses.php" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input required type="text" name="nama_mhs" class="form-control" id="inputNama" placeholder="Contoh: Muhamad Rivai" value="<?php echo $nama_mhs; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" <?php if(!isset($_GET['edit'])){echo "required";} ?> name="foto" class="form-control-file" id="foto" accept="image/*">
                    </div>
                    <div class="card-header py-3"> 
                        <?php
                            if(isset($_GET['edit'])){
