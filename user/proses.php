<?php
    ...
    if(isset($_POST['aksi'])){
        if($_POST['aksi'] == "add-dokumen"){
            $berhasil = tambahDokumen($_POST, $_FILES);

            if($berhasil){
                header("location: data-dokumen.php");
                exit;
            }else{
                echo "gagal";
            }

        } else if($_POST['aksi'] == "edit-dokumen"){
            $berhasil = editDokumen($_POST, $_FILES);
